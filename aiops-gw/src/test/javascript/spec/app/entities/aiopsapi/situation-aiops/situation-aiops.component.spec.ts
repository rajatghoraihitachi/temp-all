...
import { SituationAiopsComponent } from 'app/entities/aiopsapi/situation-aiops/situation-aiops.component';
...
describe('Component Tests', () => {
    describe('SituationAiops Management Component', () => {
        let comp: SituationAiopsComponent;
        let fixture: ComponentFixture<SituationAiopsComponent>;
        let service: SituationAiopsService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [AiopsgwTestModule],
                declarations: [SituationAiopsComponent],
                providers: [
                    {
                ...
                .overrideTemplate(SituationAiopsComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(SituationAiopsComponent);
